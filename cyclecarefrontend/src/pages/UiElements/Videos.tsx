...
export default function Videos() {
  return (
    <>
      <PageMeta
        title="React.js Videos Tabs | CycleCare - React.js Admin Dashboard Template"
        description="This is React.js Videos page for CycleCare - React.js Tailwind CSS Admin Dashboard Template"
      />
