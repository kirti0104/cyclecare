...
export default function Avatars() {
  return (
    <>
      <PageMeta
        title="React.js Avatars Dashboard | CycleCare - React.js Admin Dashboard Template"
        description="This is React.js Avatars Dashboard page for CycleCare - React.js Tailwind CSS Admin Dashboard Template"
      />
